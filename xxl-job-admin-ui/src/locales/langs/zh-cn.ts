const local: App.I18n.Schema = {
  ...
  page: {
    ...
    xxlJob: {
      dashboard: {
        title: '调度总览',
        subtitle: '先把旧报表链路迁移过来，再谈增强。',
        description: '当前首页直接复用现有 XXL-JOB 调度与统计接口，保证新旧控制台看到的是同一套真实数据。',
        jobs: '任务总数',
        logs: '调度总数',
        executors: '执行器数量',
        success: '成功次数',
      ...
      slowTasks: {
        ...
        description:
          '按任务维度聚合慢执行次数、平均耗时、峰值耗时和最近一次慢执行，支持阈值、负责人、任务标签和时间窗口筛选。'
      },
      governance: {
        title: '治理总览',
        subtitle: '先把治理面上的关键指标并到一个入口，再继续扩展更细的专题页。',
        description: '汇总任务归属、标签覆盖、失败热点、慢任务热点和最近审计事件，适合作为治理工作的统一起点。',
        jobs: '任务总数',
        ownedJobs: '已归属任务',
        taggedJobs: '已打标任务',
        auditEvents: '审计事件',
        jobsHint: '所有任务基线',
        ownedHint: 'author 字段非空',
        taggedHint: 'job_tag 字段非空',
        auditHint: '累计治理留痕',
        quickActions: '快速入口',
        quickActionsHint: '专题页继续钻取热点任务和治理记录。',
        failureTitle: '失败热点',
        failureSubtitle: '按失败次数取 Top 5',
        slowTitle: '慢任务热点',
        slowSubtitle: '按 30 秒阈值取 Top 5',
        auditTitle: '最近审计',
        auditSubtitle: '最新 8 条治理事件'
      },
      audits: {
        title: '审计日志',
