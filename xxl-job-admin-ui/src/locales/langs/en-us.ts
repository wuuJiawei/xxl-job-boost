  ...
  page: {
    ...
    xxlJob: {
      dashboard: {
        ...
        subtitle: 'Migrate the legacy reporting flow first, then improve it.',
        description:
          'This homepage directly reuses existing XXL-JOB scheduling and statistics APIs, so the new and old consoles see the same real data.',
        jobs: 'Jobs',
        logs: 'Logs',
        executors: 'Executors',
        success: 'Success',
