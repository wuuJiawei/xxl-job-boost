  ...
  <div class="page-stack">
    <div class="dashboard-hero">
      <div>
        ...
        <h2>先把任务维护主链迁过来，优先补齐 BEAN 任务的增删改查与执行。</h2>
        <p>
          当前版本覆盖查询、列表、新增、编辑、复制、删除、启停、执行一次、日志跳转、代码入口、注册节点和下次执行时间查看。
          GLUE 类任务暂时继续走旧版控制台。
        </p>
      </div>
    </div>
    ...
    <n-card :bordered="false">
      <template #header>
        <div class="table-header">
          ...
          <div class="table-subtitle">先保证 BEAN 任务可维护，GLUE 任务的专属体验后续单独迁移。</div>
        </div>
      </template>
